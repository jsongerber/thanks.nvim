...
> [!NOTE]  
> Only works with [lazy.nvim](https://github.com/folke/lazy.nvim), [packer](https://github.com/wbthomason/packer.nvim) and [mini.deps](https://github.com/echasnovski/mini.deps).  
